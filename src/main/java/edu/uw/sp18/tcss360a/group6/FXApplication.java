...
public class FXApplication extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        final Parent employeeViewAll = FXMLLoader.load(getClass().getResource(EMPLOYEE_VIEW_ALL_FXML));
        final Parent employeeBetweenDates = FXMLLoader.load(getClass().getResource(EMPLOYEE_VIEW_BETWEEN_DATES_FXML));
        final Parent employeeCancel = FXMLLoader.load(getClass().getResource(EMPLOYEE_CANCEL_FXML));
        final Parent employeeChangeMax = FXMLLoader.load(getClass().getResource(EMPLOYEE_CHANGE_MAX_FXML));
        ...
        this.sceneController.addScreen("employeeViewAllAuctions", employeeViewAll);
        this.sceneController.addScreen("employeeBetweenDates", employeeBetweenDates);
        this.sceneController.addScreen("employeeCancel", employeeCancel);
        this.sceneController.addScreen("employeeChangeMax", employeeChangeMax);
